...
<%
	...
	if (price != null && !"null".equals(value)) {
      ...
      int price_val = cm.getRecipes()[recipeNum].getPrice();
      int amtCoffee_val = cm.getRecipes()[recipeNum].getAmtCoffee();
      int amtMilk_val = cm.getRecipes()[recipeNum].getAmtMilk();
      int amtSugar_val =cm.getRecipes()[recipeNum].getAmtSugar();
      int amtChocolate_val = cm.getRecipes()[recipeNum].getAmtChocolate();

%>
<form method="post" action="edit_recipe.jsp">
<table>
<tr>
<td><input type="text" name="price" value = "<%= price_val %>"></td><td><span class="font1">Recipe Price (integer)</span></td>
</tr>
<tr>
<td><input type="text" name="amtCoffee" value = "<%= amtCoffee_val%>"></td><td><span class="font1">Units Coffee</span></td>
</tr>
<tr>
<td><input type="text" name="amtMilk" value = "<%= amtMilk_val %>"></td><td><span class="font1">Units Milk</span></td>
</tr>
<tr>
<td><input type="text" name="amtSugar" value = "<%= amtSugar_val%>"></td><td><span class="font1">Units Sugar</span></td>
</tr>
<tr>
<td><input type="text" name="amtChocolate" value = "<%= amtChocolate_val %>"></td><td><span class="font1">Units Chocolate</span></td>
</tr>
</table>
